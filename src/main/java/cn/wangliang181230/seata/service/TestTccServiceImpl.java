...
public class TestTccServiceImpl implements ITestTccService {
	...
	public void commit(BusinessActionContext context) {
		LOGGER.info("test tcc: commit, xid: {}, a: {}, map: {}", context.getXid(), context.getActionContext("a"), context.getActionContext());
	}

	@Override
	public void rollback(BusinessActionContext context) {
		LOGGER.info("test tcc: rollback, xid: {}, a: {}, map: {}", context.getXid(), context.getActionContext("a"), context.getActionContext());
	}
}
